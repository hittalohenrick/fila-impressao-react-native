...
export default function App() {
  ...
  return (
    <View style={styles.container}>
      ...
      <Button title="Agendar Tarefa" onPress={adicionarTarefa} color="#2196F3" />
      <Button title="Executar próxima" onPress={processarTarefa} color="#4CAF50" />
      ...
      <FlatList
        ...
        renderItem={({ item, index }) => (
          <Text>{index + 1}. {item.id} - {item.tempo}s</Text>
        )}
      />
    </View>
  );
